...
#SENSOR DECLARATIONS
sensor_missing = {"lps": [False, 2], "bmp": [False, 3], "sgp": [False, 4], "aht": [False, 5]}
...
try:
    ...
    while True:
        ...
        #STATUS LED
        for sensor_name in sensor_missing:
            if sensor_missing[sensor_name][0]:
                num_blinks = sensor_missing[sensor_name][1]
                break
        else:
            num_blinks = 1
